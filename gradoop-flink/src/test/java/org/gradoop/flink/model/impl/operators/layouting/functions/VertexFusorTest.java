...
public class VertexFusorTest {
  ...
  public void testSuperVertexGenerator() throws Exception{
    ...
    LVertex donor2 = new LVertex(GradoopId.get(),new Vector(1000,1000),-1,3,new Vector(10,10));
    LVertex donor3 = new LVertex(GradoopId.get(),new Vector(10000,10000),-1,1,new Vector(10,10));
    ...
    Vector expectedPosition =
      receiver.getPosition().mul(5).add(donor1.getPosition()).add(donor2.getPosition().mul(3)).add(donor3.getPosition()).div(10);
