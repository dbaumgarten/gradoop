...
public class CombiLayouter implements LayoutingAlgorithm{
  ...
  public CombiLayouter(int iterations, int numVertices, double quality){
    ...
    if (l2iterations > 0) {
      layouter2 =
        new FRLayouter(l2iterations, numVertices).useExistingLayout(layouter1 != null).startAtIteration(l1iterations);
    }
  }
  ...
  public String toString() {
    return "CombiFRLayouter{" +" quality=" + quality + ", iterations=" + iterations + ", k=" + getK() + "," +
      " " + "with=" + getWidth() +
