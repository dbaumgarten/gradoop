...
public class Plotter {
   ...
   *
   * @param g    The graph to plot. NEEDS to have properties (X,Y) for the position on EVERY
   *             vertex.
   * @param path The path to save the generated file to. The given file-extension determines
   *             the used image-type.
  ...
  /**
   * Generate and save the image of the graph. HAS TO be called after read() and AFTER the
   * flink-graph has been executed.
   *
   * @param path The path to save the generated file to. The given file-extension determines the
   *             used image-type.
   */
